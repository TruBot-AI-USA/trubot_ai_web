...
export const metadata = {
  title: "TruCRM – AI-Powered Customer Relationship Management",
  description: "Streamline your sales pipelines, manage leads, and enhance customer relationships with AI. TruCRM provides intelligent automation and analytics.",
};
...
const LeadPipelineCard = () => (
  <div className="bg-white p-6 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-gray-100 w-full max-w-md mx-auto relative z-10">
    <div className="flex justify-between items-center mb-6">
      ...
      <span className="bg-green-100 text-green-700 text-xs font-bold px-2 py-1 rounded">Real-time</span>
    </div>
    ...
    <div className="p-6 border-b border-gray-50">
       <div className="flex justify-between items-start mb-4">
          <div className="flex items-center gap-2">
             <div className="bg-green-100 p-2 rounded text-green-600"><FileText size={20}/></div>
             <div>
                <div className="font-bold text-gray-900 text-sm">Quotation #Q-2024-1247</div>
                <div className="text-xs text-gray-500">Acme Corporation</div>
             </div>
          </div>
          <span className="bg-yellow-100 text-yellow-700 text-[10px] font-bold px-2 py-0.5 rounded">Pending</span>
       </div>
        ...
        <PageLayout className="flex flex-col items-center gap-12 mx-auto md:flex-row py-12 lg:pt-5 lg:pb-20">
          ...
          <div className="flex-1 w-full text-center md:text-left z-10">
            ...
            <h1 className="mb-6 text-4xl font-bold text-white md:text-6xl leading-tight">
              ...
              <br />
              <span className="text-blue-200">{heroSection.title.highlight}</span>
            </h1>
          ...
          <div className="relative flex-1 w-full max-w-lg mt-12 md:mt-0 z-10">
            ...
            <div className="absolute bottom-8 -left-4 md:-left-12 bg-white p-6 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] animate-in fade-in slide-in-from-bottom-6 hidden md:block max-w-[240px] z-20">
                 <p className="text-gray-500 text-xs font-bold uppercase tracking-wide mb-2">Sales This Month</p>
           ...
           <PageLayout>
              <div className="flex flex-col lg:flex-row items-center gap-16">
                 ...
                 <div className="flex-1 space-y-6">
                    <span className="inline-block px-3 py-1 text-sm font-semibold text-blue-600 bg-blue-100 rounded-full">Email Management</span>
                    <h2 className="text-3xl md:text-4xl font-bold text-navy">{detailedFeatures[0].title}</h2>
                    <p className="text-lg text-gray-600">{detailedFeatures[0].description}</p>
                    <div className="space-y-4 pt-4">
                       {detailedFeatures[0].features.map((feat, i) => (
                          <div key={i} className="flex gap-4">
                             <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-blue-50 text-blue-600"><feat.icon size={20}/></div>
                             <div><h4 className="font-bold">{feat.title}</h4><p className="text-sm text-gray-600">{feat.description}</p></div>
                          </div>
                       ))}
                    </div>
                 </div>
                 ...
                 <div className="flex-1 w-full relative">
                    <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-100">
                       <Image src={detailedFeatures[0].imageSrc} alt={detailedFeatures[0].imageAlt} width={600} height={450} className="w-full object-cover"/>
                    </div>
                    ...
                    <div className="absolute -bottom-10 -left-6 bg-white p-4 rounded-xl shadow-lg border border-gray-100 w-56 hidden md:block">
                        <div className="flex items-center gap-2 mb-2 text-sm font-bold text-gray-800">
                           <div className="text-blue-500"><CheckCircle2 size={16}/></div> Email Sync Status
                        </div>
                        <div className="flex justify-between text-xs text-gray-500 mt-2 pt-2 border-t">
                           <div><div className="font-bold text-gray-900 text-lg">247</div>Sent Today</div>
                           <div><div className="font-bold text-gray-900 text-lg">68%</div>Response</div>
                        </div>
                    </div>
                    ...
                    <div className="absolute top-10 -right-8 bg-white p-3 rounded-lg shadow-lg flex-items-center gap-3 border border-gray-100 hidden md:flex">
                        <div className="text-blue-600 bg-blue-50 p-2 rounded-full"><Clock size={16}/></div>
                        <div>
                           <div className="text-[10px] text-gray-500 uppercase font-bold">Avg Response Time</div>
        ...
        <div className=" bg-blue-50/30">
           <PageLayout>
              <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
                 {/* Text */}
                 <div className="flex-1 space-y-6">
                    <span className="inline-block px-3 py-1 text-sm font-semibold text-purple-600 bg-purple-100 rounded-full">Lead Generation</span>
                    <h2 className="text-3xl md:text-4xl font-bold text-navy">{detailedFeatures[1].title}</h2>
                    <p className="text-lg text-gray-600">{detailedFeatures[1].description}</p>
                    <div className="space-y-4 pt-4">
                       {detailedFeatures[1].features.map((feat, i) => (
                          <div key={i} className="flex gap-4">
                             <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-purple-50 text-purple-600"><feat.icon size={20}/></div>
                             <div><h4 className="font-bold">{feat.title}</h4><p className="text-sm text-gray-600">{feat.description}</p></div>
                          </div>
                       ))}
                    </div>
                    <div className="pt-4"><Button label="Start Managing Leads" variant="primary" /></div>
                 </div>
                 {/* Component */}
        ...
        <div className=" bg-white">
           <PageLayout>
              <div className="flex flex-col lg:flex-row items-center gap-16">
                 {/* Text */}
                 <div className="flex-1 space-y-6">
                    <span className="inline-block px-3 py-1 text-sm font-semibold text-pink-600 bg-pink-100 rounded-full">Opportunity Management</span>
                    <h2 className="text-3xl md:text-4xl font-bold text-navy">{detailedFeatures[2].title}</h2>
                    <p className="text-lg text-gray-600">{detailedFeatures[2].description}</p>
                    <div className="space-y-4 pt-4">
                       {detailedFeatures[2].features.map((feat, i) => (
                          <div key={i} className="flex gap-4">
                             <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-pink-50 text-pink-600"><feat.icon size={20}/></div>
                             <div><h4 className="font-bold">{feat.title}</h4><p className="text-sm text-gray-600">{feat.description}</p></div>
                          </div>
                       ))}
                    </div>
                 ...
                 <div className="flex-1 w-full relative">
                    <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-100">
                       <Image src={detailedFeatures[2].imageSrc} alt={detailedFeatures[2].imageAlt} width={600} height={450} className="w-full object-cover"/>
                    </div>
                    ...
                    <div className="absolute -bottom-8 -left-8 bg-white p-5 rounded-xl shadow-xl border border-gray-100 hidden md:block">
                        <p className="text-xs text-gray-500 mb-3 font-semibold">Active Opportunities</p>
                        <div className="flex items-center gap-3 mb-3">
                           <div className="bg-green-100 text-green-600 p-1.5 rounded-full"><CheckCircle2 size={16}/></div>
                           <div>
                              <div className="text-[10px] text-gray-500">Won This Month</div>
                              <div className="font-bold text-gray-900">$485K</div>
                           </div>
                        </div>
                        <div className="flex items-center gap-3">
                           <div className="bg-blue-100 text-blue-600 p-1.5 rounded-full"><TrendingUp size={16}/></div>
                           <div>
        ...
        <div className=" bg-green-50/30">
           <PageLayout>
              <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
                 {/* Text */}
                 <div className="flex-1 space-y-6">
                    <span className="inline-block px-3 py-1 text-sm font-semibold text-teal-600 bg-teal-100 rounded-full">Customer Management</span>
                    <h2 className="text-3xl md:text-4xl font-bold text-navy">{detailedFeatures[3].title}</h2>
                    <p className="text-lg text-gray-600">{detailedFeatures[3].description}</p>
                    <div className="space-y-4 pt-4">
                       {detailedFeatures[3].features.map((feat, i) => (
                          <div key={i} className="flex gap-4">
                             <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-teal-50 text-teal-600"><feat.icon size={20}/></div>
                             <div><h4 className="font-bold">{feat.title}</h4><p className="text-sm text-gray-600">{feat.description}</p></div>
                          </div>
                       ))}
                    </div>
                 ...
                 <div className="flex-1 w-full relative">
                    <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-100">
                       <Image src={detailedFeatures[3].imageSrc} alt={detailedFeatures[3].imageAlt} width={600} height={450} className="w-full object-cover"/>
                    </div>
                    ...
                    <div className="absolute top-8 -right-8 bg-white p-4 rounded-xl shadow-xl border border-gray-100 w-64 hidden md:block">
                        <div className="flex items-center gap-3 mb-3">
                           <div className="bg-teal-600 text-white w-10 h-10 rounded-full flex items-center justify-center font-bold">JD</div>
                           <div>
                              <div className="font-bold text-gray-900">John Davis</div>
                              <div className="text-xs text-gray-500">Premium Customer</div>
                           </div>
                        </div>
                        ...
                        <div className="text-xs text-gray-500 space-y-1">
                           <div className="flex justify-between"><span>Lifetime Value:</span> <span className="font-bold text-gray-900">$12,450</span></div>
                           <div className="flex justify-between"><span>Last Contact:</span> <span>2 days ago</span></div>
                        </div>
                    </div>
                 </div>
              </div>
        ...
        <PageLayout>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {activitySection.cards.map((card, idx) => (
              <div key={idx} className="bg-white rounded-2xl p-8 border border-gray-100 shadow-lg hover:shadow-2xl transition-all duration-300">
        ...
        <PageLayout>
           <div className="flex flex-col lg:flex-row items-center gap-16">
              <div className="flex-1 space-y-8">
                 ...
                 <h2 className="text-4xl font-bold text-navy">{quotesSection.title}</h2>
                 <p className="text-lg text-gray-600">{quotesSection.description}</p>
                 
                 <div className="space-y-6">
                    {quotesSection.features.map((feat, i) => (
                       <div key={i} className="flex gap-4">
                          <div className={`p-2 rounded-lg bg-white shadow-sm h-fit ${feat.color}`}>
                             <feat.icon size={20} />
                          </div>
                          <div>
              ...
              <div className="flex-1 w-full relative">
                 ...
                 <div className="absolute top-1/2 -right-4 translate-y-12 bg-white p-4 rounded-xl shadow-xl border border-gray-100 hidden lg:block w-48">
                    <p className="text-xs font-bold text-gray-500 mb-2">Quote Performance</p>
      ...
      <div className="bg-white">
        <PageLayout>
           <div className="text-center mb-16">
              ...
              <h2 className="text-4xl font-bold text-navy mt-4 mb-4">{analyticsSection.title}</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">{analyticsSection.subtitle}</p>
           </div>

           {/* 3 Colored Dashboard Cards */}
           <div className="grid md:grid-cols-3 gap-8 mb-20">
              {analyticsSection.cards.map((card, idx) => (
                 <div key={idx} className={`${card.color} rounded-2xl p-8 shadow-xl relative overflow-hidden group hover:-translate-y-2 transition-transform duration-300`}>
           ...
           <div className="flex flex-col lg:flex-row items-center gap-12 bg-gray-50 rounded-3xl p-8 md:p-12">
               ...
               <div className="flex-1 space-y-8">
                  <h3 className="text-3xl font-bold text-gray-900">Comprehensive Analytics Suite</h3>
                  <div className="space-y-6">
