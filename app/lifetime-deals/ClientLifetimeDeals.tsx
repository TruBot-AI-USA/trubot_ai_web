...
const ltdProducts: LTDProduct[] = [
  {
    ...
    description:
      "Access millions of B2B contacts with advanced filtering and export capabilities to accelerate prospecting and outreach.",
    icon: Zap,
    bg: "bg-blue-100",
    ...
    tiers: [
      {
        ...
        price: "1250",
        description:
          "Full-power lead generation suite for high-volume sales teams and agencies.",
        features: [
  ...
  },
  {
    ...
    description:
      "A powerful CRM that helps you organize contacts, track deals, manage activities, and close more sales—all without monthly subscriptions.",
    icon: Users,
    bg: "bg-teal-100",
    ...
    tiers: [
      {
        ...
        price: "1250",
        description:
          "Complete CRM platform for teams that need a central place to manage contacts, deals, and pipeline.",
        features: [
          "Contact management",
          "Lead tracking",
  ...
  },
  {
    ...
    description:
      "Manage inventory, suppliers, orders, invoicing, and business operations from a single platform.",
    icon: Building2,
    bg: "bg-amber-100",
    ...
    tiers: [
      {
        ...
        price: "1250",
        description:
          "Full-featured ERP system for businesses that need streamlined operations and financial management.",
        features: [
  ...
  },
  {
    ...
    description:
      "Plan, organize, and publish your social media content with an intuitive scheduling platform.",
    icon: MessageSquare,
    bg: "bg-pink-100",
    ...
    tiers: [
      {
        ...
        price: "299",
        description:
          "Essential social media scheduling for individuals and small teams managing a few accounts.",
        features: [
      ...
      },
      {
        ...
        price: "1250",
        description:
          "Advanced social media management for agencies and teams publishing at scale.",
        features: [
...
const truSuiteBundle: LTDProduct & { bundleTier: LTDProductTier } = {
  ...
  description:
    "Get all TruBotAI products in one complete bundle — TruLead, TruCRM, TruERP, and TruSocial — with shared infrastructure, unified dashboard, and premium support.",
  icon: Gift,
  bg: "bg-amber-100",
  iconColor: "text-amber-600",
  tiers: [],
  bundleTier: {
    ...
    price: "2499",
    description:
      "The complete TruBotAI ecosystem — all four products in one unified bundle at a massive discount compared to buying individually.",
    features: [
      "TruLead",
      "TruCRM — Core CRM",
      "TruERP — Core ERP",
...
const whyChooseItems = [
  {
    icon: Clock,
    title: "Pay Once",
    desc: "Make a single payment and enjoy lifetime access to your selected product.",
    color: "from-blue-500 to-blue-600",
  },
  {
    icon: PiggyBank,
    title: "Save Thousands",
    desc: "Avoid recurring subscription fees and maximize long-term savings.",
    color: "from-green-500 to-green-600",
  },
  {
    icon: TrendingUp,
    title: "Built for Growing Businesses",
    desc: "Perfect for startups, agencies, consultants, and SMBs.",
    color: "from-purple-500 to-purple-600",
  },
  {
    icon: RefreshCw,
    title: "Future Updates Included",
    desc: "Receive future improvements and feature updates for your purchased Lifetime tier with additional cost.",
    color: "from-orange-500 to-orange-600",
  },
  {
    icon: Shield,
    title: "Secure & Reliable",
    desc: "Built on enterprise-grade cloud infrastructure with secure hosting.",
...
const addOns = [
  {
    ...
    desc: "Enhance your products with cutting-edge AI capabilities.",
  },
  {
    icon: HardDrive,
    label: "Additional storage",
    desc: "Expand your storage capacity as your business grows.",
  },
  {
    icon: Users,
    label: "Extra user seats",
    desc: "Add more team members to collaborate on your platform.",
  },
  {
    icon: Package,
    label: "Usage credits",
    desc: "Top up your usage quotas for high-volume operations.",
  },
  {
    icon: Headphones,
    label: "Premium support",
    desc: "Get priority support with faster response times.",
  },
  {
    icon: Puzzle,
    label: "Advanced integrations",
    desc: "Connect with additional third-party tools and services.",
  },
];
...
export default function ClientLifetimeDeals() {
        ...
        <div className="mx-auto w-full max-w-[1400px] px-6 md:px-8 lg:px-12 relative z-10">
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 mb-10">
              ...
              <Button
                href="#compare"
                className="bg-blue-600 hover:bg-blue-700 text-white text-sm font-bold px-7 py-3 rounded-xl transition-all duration-200"
                label={""}
              >
                Compare Plans
              </Button>
              ...
              return (
                ...
                >
                  <div className="flex flex-col flex-1">
                    ...
                    <p className="text-sm text-gray-500 leading-relaxed mb-3">{selectedTier.description}</p>
            ...
            <div className="relative bg-gradient-to-br from-amber-50/40 to-white border-2 border-amber-300/50 rounded-2xl px-6 md:px-8 pt-6 pb-6 transition-all duration-300 hover:border-amber-400 hover:shadow-xl hover:shadow-amber-200/20 hover:-translate-y-1.5 overflow-hidden">
              ...
              <div className="grid md:grid-cols-5 gap-6 md:gap-8 items-center">
                <div className="md:col-span-3">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed mb-4 max-w-xl">{truSuiteBundle.description}</p>
                ...
                {comparisonData.map((row, i) => (
                  <motion.tr
                    ...
                    className={`border-b border-gray-100 transition-colors hover:bg-blue-50/30 ${
                      row.product === "TruSuite Bundle" ? "bg-amber-50/40" : ""
                    }`}
                  >
                    <td className="py-4 px-4">
                      <span className={`text-sm font-medium ${
                        row.product === "TruSuite Bundle" ? "text-amber-700" : "text-gray-800"
                      }`}>
                        {row.product}
                    ...
                    <td className="py-4 px-4 text-right">
                      <span className="text-sm font-semibold text-[#18352b]">{row.price}</span>
                    </td>
                  </motion.tr>
                ))}
              </tbody>
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        ...
        <div className="mx-auto w-full max-w-[1400px] px-6 md:px-8 lg:px-12 relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#18352b]">
              What&apos;s Included with Every <span className="text-blue-600">Lifetime Deal</span>
            </h2>
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">
            ...
            <div>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                {[
                  {
                    icon: Infinity,
                    label: "Lifetime Access to Purchased Plan",
                    desc: "Ongoing use of your purchased Lifetime tier with no expirations or renewals.",
                  },
                  {
                    icon: Check,
                    label: "One-Time Payment",
                    desc: "A single payment locks in your access forever — no recurring fees or subscriptions.",
                  },
                  {
                    icon: Cloud,
                    label: "Secure Cloud Hosting",
                    desc: "Enterprise-grade infrastructure with reliable, encrypted hosting included.",
                  },
                  {
                    icon: RefreshCw,
                    label: "Core Product Updates",
                    desc: "Receive essential feature updates, security patches, and improvements at no extra cost.",
                  },
                  {
                    icon: Package,
                    label: "Access to Purchased Lifetime Tier",
                    desc: "Full access to the specific Lifetime tier you purchased, including all its features.",
                  },
                  {
                    icon: TrendingUp,
                    label: "Upgrade Path for Premium Add-Ons",
                    desc: "Optional upgrade path for premium add-ons when your business needs more power.",
                  },
                ].map((item, i) => (
                  <motion.div
                    key={item.label}
            ...
            <div>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  {
                    icon: Mail,
                    label: "Dedicated Email Support",
                    desc: "Available as a paid add-on — get priority email support with faster response times for your team.",
                  },
                  {
                    icon: Sparkles,
                    label: "Future Feature Enhancements",
                    desc: "Available as a paid add-on — access to upcoming premium features and major version upgrades.",
                  },
                  {
                    icon: Cpu,
                    label: "AI Features",
                    desc: "Unlock AI-powered capabilities like lead scoring, content generation, and analytics.",
                  },
                  {
                    icon: HardDrive,
                    label: "Additional Storage",
                    desc: "Expand your storage capacity as your business data grows.",
                  },
                  {
                    icon: Users,
                    label: "Additional User Seats",
                    desc: "Add more team members to collaborate across your platform.",
                  },
                  {
                    icon: Database,
                    label: "Usage Credits",
                    desc: "Top up usage quotas for high-volume operations and data exports.",
                  },
                  {
                    icon: Headphones,
                    label: "Priority Support",
                    desc: "White-glove support with dedicated SLAs and faster resolution times.",
                  },
                  {
                    icon: BarChart3,
                    label: "Premium Analytics",
                    desc: "Advanced reporting dashboards and custom analytics for deeper insights.",
                  },
                  {
                    icon: Puzzle,
                    label: "Advanced Integrations",
                    desc: "Connect with additional third-party tools, APIs, and enterprise systems.",
                  },
                ].map((item, i) => (
                  <motion.div
                    key={item.label}
        ...
        <div className="mx-auto w-full max-w-[1400px] px-6 md:px-8 lg:px-12 relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-4 leading-tight">
              Don&apos;t Miss This <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-yellow-400">Limited-Time Offer</span>
            </h2>
