...
const filterSubCategories: Record<string, SubCategory[]> = {
  ...
  "data-assets": [
    ...
    { name: "Leads (1M)", slug: "1m-leads", price: "99" },  
  ],
  "leads-bulk": [
  ...
  "sdlc-templates": [
    ...
    { name: "Product PRD", slug: "product-prds", price: "49" },
...
const productDetails: Record<string, ProductDetails> = {
  ...
  "Leads (250K)": {
    longDesc:
      "A compact, targeted B2B lead dataset with 250,000 records. Perfect for smaller teams, niche campaigns, and budget-conscious outreach. Get clean, ready-to-use data without the enterprise price tag.",
...
const categories: Category[] = [
  { name: "All Assets Bundle", tag: "bundle", icon: Gift, price: "5299", href: "/digitalAssets/all-assets-bundle", bg: "bg-amber-100", iconColor: "text-amber-600", desc: "Every digital asset in our marketplace at a massive discount. Get everything in one bundle." },
  { name: "Finance Templates", tag: "finance", icon: Calculator, price: "499", href: "/digitalAssets/finance-templates", bg: "bg-blue-100", iconColor: "text-blue-600", desc: "Professional financial planning and analysis templates. Budget, forecast, and report with ease to drive smarter business decisions." },
  { name: "Investor", tag: "data-assets", icon: Briefcase, price: "399", href: "/digitalAssets/investor-database", bg: "bg-purple-100", iconColor: "text-purple-600", desc: "Curated investor database with detailed funding preferences and contact info. Connect with the right VCs and angels for your startup." },
  { name: "Grant", tag: "data-assets", icon: Database, price: "199", href: "/digitalAssets/grant-database", bg: "bg-green-100", iconColor: "text-green-600", desc: "Comprehensive grant database with eligibility filters and deadline tracking. Find and secure funding for your next big project." },
  { name: "Accelerator", tag: "data-assets", icon: Rocket, price: "49", href: "/digitalAssets/accelerator-database", bg: "bg-orange-100", iconColor: "text-orange-600", desc: "Top startup accelerator programs with application details and success metrics. Get into the best programs to scale faster." },
  { name: "Leads (1M)", tag: "data-assets", icon: Users, price: "99", href: "/digitalAssets/1m-leads", bg: "bg-pink-100", iconColor: "text-pink-600", desc: "1 million B2B leads across industries and regions. Target, filter, and convert your ideal customer profiles." },
  { name: "Leads (250K)", tag: "data-assets", icon: Users, price: "49", href: "/digitalAssets/250k-leads", bg: "bg-pink-100", iconColor: "text-pink-600", desc: "250,000 B2B leads — a compact, targeted dataset for focused outreach campaigns." },
  { name: "AI LinkedIn Prompts Pack", tag: "ai", icon: Sparkles, price: "49", href: "/digitalAssets/ai-linkedin-prompts", bg: "bg-indigo-100", iconColor: "text-indigo-600", desc: "AI-powered prompt templates for LinkedIn content creation. Generate engaging posts, comments, and outreach messages that get results." },
  { name: "Cold Email Templates", tag: "ai", icon: Mail, price: "49", href: "/digitalAssets/cold-email-templates", bg: "bg-blue-100", iconColor: "text-blue-600", desc: "Proven cold email templates that get replies, book meetings, and close deals." },
  { name: "Architecture PRD", tag: "sdlc-templates", icon: Building2, price: "49", href: "/digitalAssets/architecture-prd", bg: "bg-teal-100", iconColor: "text-teal-600", desc: "Comprehensive architecture documentation templates for system design. Define constraints, trade-offs, and technical decisions with clarity." },
  { name: "Product PRD", tag: "sdlc-templates", icon: FileText, price: "49", href: "/digitalAssets/product-prds", bg: "bg-amber-100", iconColor: "text-amber-600", desc: "Ready-to-use product requirement document templates. Streamline product planning, align stakeholders, and ship with confidence." },
  { name: "Proposals Docs", tag: "sdlc-templates", icon: FileText, price: "99", href: "/digitalAssets/proposals-docs", bg: "bg-blue-100", iconColor: "text-blue-600", desc: "Professional proposal and business plan templates for grant applications and client pitches." },
  { name: "Project Timeline Templates", tag: "sdlc-templates", icon: Calendar, price: "49", href: "/digitalAssets/project-timeline-templates", bg: "bg-teal-100", iconColor: "text-teal-600", desc: "Professional project timeline and Gantt chart templates to plan, track, and deliver projects on time." },
  { name: "Website Content", tag: "sdlc-templates", icon: Globe, price: "199", href: "/digitalAssets/website-content", bg: "bg-cyan-100", iconColor: "text-cyan-600", desc: "15 professionally written content documents covering every page of an AI startup website." },
  { name: "Lean PRD", tag: "sdlc-templates", icon: FileText, price: "99", href: "/digitalAssets/lean-prd", bg: "bg-amber-100", iconColor: "text-amber-600", desc: "Streamlined Lean PRD template to define, validate, and communicate product requirements fast." },
  { name: "GTM", tag: "strategy", icon: Crosshair, price: "199", href: "/digitalAssets/gtm-strategy", bg: "bg-sky-100", iconColor: "text-sky-600", desc: "Structured go-to-market frameworks and strategy templates. Move from idea to market with clarity, confidence, and a plan that scales." },
  { name: "Pitch Deck Samples", tag: "strategy", icon: Send, price: "99", href: "/digitalAssets/pitch-deck-samples", bg: "bg-orange-100", iconColor: "text-orange-600", desc: "Professional pitch deck templates that help you tell your story and win investors." },
  { name: "NDA and Agreements", tag: "strategy", icon: Shield, price: "99", href: "/digitalAssets/nda-pack", bg: "bg-slate-100", iconColor: "text-slate-600", desc: "Professional NDA templates, AI prompts, dashboards, documentation, and SOP tools for founders and LLPs." },
  { name: "M&A", tag: "strategy", icon: TrendingUp, price: "199", href: "/digitalAssets/ma-strategy", bg: "bg-emerald-100", iconColor: "text-emerald-600", desc: "Professional M&A strategy frameworks, analysis tools, valuation templates, and deal documentation." },
  { name: "Channel Partner Pack", tag: "strategy", icon: Handshake, price: "99", href: "/digitalAssets/channel-partners", bg: "bg-violet-100", iconColor: "text-violet-600", desc: "Everything to launch, manage, and scale a channel partner programme — templates, playbooks, and tools." },
  { name: "Real Estate", tag: "real-estate", icon: Home, price: "199", href: "/digitalAssets/real-estate", bg: "bg-rose-100", iconColor: "text-rose-600", desc: "Professional-grade templates, trackers, and workflows for landlords, property investors, and real estate pros." },
  { name: "Leads (150M)", tag: "leads-bulk", icon: Database, price: "1999", href: "/digitalAssets/150m-leads", bg: "bg-purple-100", iconColor: "text-purple-600", desc: "150 million B2B leads — the ultimate dataset for enterprise-scale outreach campaigns." },
  { name: "Leads (390M)", tag: "leads-bulk", icon: Database, price: "3999", href: "/digitalAssets/390m-leads", bg: "bg-indigo-100", iconColor: "text-indigo-600", desc: "390 million B2B leads — the most comprehensive B2B dataset available." },
];
...
export default function digitalAssets() {
  ...
  const currentProductSlug =
    selectedProductSlug || filterToSlugs[activeFilter]?.[0] || null;
