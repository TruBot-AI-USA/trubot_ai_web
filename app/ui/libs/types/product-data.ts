...
export const products: Record<string, ProductData> = {
  ...
  "1m-leads": {
    name: "Leads (1M)",
    tagline: "1 million B2B leads — launch your outreach campaigns today.",
    description: "1 million B2B leads across industries and regions. Target, filter, and convert your ideal customer profiles.",
    ...
    price: 99,
    icon: Users,
    features: ["1M+ B2B records", "Company & contact data", "Industry classification", "Decision-maker titles", "Geographic coverage", "CRM-ready export"],
    ...
    keyBenefits: ["Skip weeks of list building", "contact information", "Ready for any outreach tool", "B2B focused & segmented", "One-time purchase — use forever", "No subscription or hidden fees"],
  ...
  "250k-leads": {
    name: "Leads (250K)",
    tagline: "250K+ B2B leads — launch your outreach campaigns today.",
    description: "250K+ B2B leads across industries and regions. Target, filter, and convert your ideal customer profiles.",
    longDescription: "Launch campaigns today, not next week. Building outreach lists is slow, expensive, and repetitive. This gives you a ready-made database so your team can start sending campaigns immediately.",
    price: 49,
    icon: Users,
    features: ["250K+ B2B records", "Company & contact data", "Industry classification", "Decision-maker titles", "Geographic coverage", "CRM-ready export"],
  ...
  "lean-prd": {
    ...
    longDescription: "Learn from real PRD examples used by professional product teams. Our Lean PRDs give you a clear template for defining features, writing user stories, setting acceptance criteria, and aligning stakeholders.",
    price: 99,
    icon: FileText,
    features: ["Real PRD Lean documents", "User story frameworks", "Acceptance criteria examples", "Feature specification templates", "Priority & roadmap matrices", "Stakeholder alignment guides"],
    whatsIncluded: ["Lean PRD documents", "User story templates", "Acceptance criteria guides", "Feature spec templates", "Priority matrix frameworks", "Best practices handbook"],
    ...
    deliverables: ["Lean PRD documents", "Editable templates", "Best practices guide"],
    color: "from-amber-500/10 to-amber-600/5",
    bgColor: "bg-amber-50",
    iconBg: "bg-amber-100",
    iconColor: "text-amber-600",
  ...
  "150m-leads": {
    name: "Leads (150M)",
    tagline: "150 million B2B leads — the ultimate dataset for enterprise-scale outreach.",
    description: "150 million B2B leads across industries, regions, and decision-maker titles. The ultimate dataset for enterprise-scale outreach campaigns.",
    longDescription: "Enterprise-scale lead database covering 150 million B2B records. Perfect for large-scale outreach campaigns, market analysis, and data-driven sales strategies across multiple industries and geographies.",
    price: 1999,
    icon: Database,
    features: ["150M+ B2B records", "Global company & contact data", "Industry & sector classification", "Decision-maker titles & seniority", "Multi-geographic coverage", "Enterprise-ready CSV export"],
    ...
    keyBenefits: ["Enterprise-scale dataset", "contact information", "Ready for any outreach platform", "Global geographic coverage", "One-time purchase — use forever", "No subscription or hidden fees"],
  ...
  "390m-leads": {
    name: "Leads (390M)",
    tagline: "390 million B2B leads — the most comprehensive B2B dataset available.",
    description: "390 million B2B leads — the most comprehensive B2B dataset available for maximum market coverage.",
    longDescription: "The ultimate B2B lead database covering 390 million records. The most comprehensive dataset for organizations that need maximum market coverage across all industries, geographies, and decision-maker levels.",
    price: 3999,
    icon: Database,
    features: ["390M+ B2B records", "Complete global coverage", "All industry classifications", "All decision-maker levels", "Every geographic region", "Enterprise-ready delivery"],
  ...
  "all-assets-bundle": {
    ...
    whatsIncluded: ["Accelerator ($49 value)", 
      "AI LinkedIn Prompts Pack ($49 value)", 
      "Architecture PRD ($49 value)",
      "Channel Partner Pack ($99 value)", 
      "Cold Email Templates ($49 value)",          
      "Finance Templates ($499 value)",
      "Grant ($199 value)",  
      "GTM ($199 value)",   
      "Investor ($399 value)", 
      "Leads (1M) ($99 value)",
      "Leads (250K) ($49 value)",      
      "Leads (150M) ($1,999 value)", 
      "Leads (390M) ($3,999 value)",
      "Lean PRD ($99 value)",      
      "M&A ($199 value)",
      "NDA and Agreements ($99 value)",
      "Pitch Deck Samples ($99 value)",          
      "Product PRD ($49 value)", 
      "Project Timeline Templates ($49 value)", 
      "Proposals Docs ($99 value)",    
      "Real Estate ($199 value)", 
      "Website Content ($199 value)",
      "And more..."],
...
export const filterToSlugs: Record<string, string[]> = {
  ...
  "data-assets": ["accelerator-database", "grant-database","investor-database", "1m-leads","250k-leads"],
  "sdlc-templates": ["architecture-prd", "lean-prd", "product-prds", "proposals-docs", "project-timeline-templates", "website-content"],
