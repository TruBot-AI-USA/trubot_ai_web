...
export const products: Record<string, ProductData> = {
  ...
  "1m-leads": {
   ...
   "250k-leads": {
    name: "Leads (250K)",
    tagline: "250K verified B2B leads — launch your outreach campaigns today.",
    description: "250K verified B2B leads across industries and regions. Target, filter, and convert your ideal customer profiles.",
    longDescription: "Launch campaigns today, not next week. Building outreach lists is slow, expensive, and repetitive. This gives you a ready-made database so your team can start sending campaigns immediately.",
    price: 49,
    icon: Users,
...
export const filterToSlugs: Record<string, string[]> = {
  ...
  "dataAssets": ["accelerator-database", "grant-database","investor-database", "1m-leads","250k-leads"],
  "template": ["architecture-prd", "product-prds", "proposals-docs", "sample-prd", "project-timeline-templates", "website-content"],
